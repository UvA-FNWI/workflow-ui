...
export function RubricPopover({
    ...
    return (
        <Popover
            ...
            placement="top end"
            className="my-1 max-h-[80vh] max-w-[calc(100vw-1.5rem)] overflow-y-auto border border-grey-500 bg-grey-200 shadow-md outline-none sm:max-w-200 dark:bg-grey-800"
        >
